...
export default function MultiSlider_2() {
  ...
  return (
    ...
    <div className="mx-auto text-2xl flex justify-center font-bold  text-white"> {t("TOP BRANDS, LATEST MODELS")}</div>
